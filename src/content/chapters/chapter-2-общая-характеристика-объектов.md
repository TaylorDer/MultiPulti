...
![Рис. 2.1. Представлениеобъекта с именем Стул](/images/milovanov/ris_2_1.jpg)
...
1. селектор (даёт доступ к состоянию, но не изменяет его);
1. итератор (доступ к содержанию объекта по частям в строго определённом порядке);
1. конструктор (создаёт объект и инициализирует его состояние);
1. деструктор (разрушает объект и освобождает занимаемую им память).
...
![Рис. 2.2. Методы исвободные подпрограммы](/images/milovanov/ris_2_2.jpg)

**Рис. 2.2. Методы исвободные подпрограммы**

![Рис. 2.3. Пространство поведения объекта](/images/milovanov/ris_2_3.jpg)
...
![Рис. 2.4. Активные ипассивные объекты](/images/milovanov/ris_2_4.jpg)
