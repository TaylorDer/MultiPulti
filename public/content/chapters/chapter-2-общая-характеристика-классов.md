...
публичную (public), объявления которой доступны всем кли- ентам;

защищённую (protected), объявления которой доступны только самому классу, его подклассам и друзьям;
